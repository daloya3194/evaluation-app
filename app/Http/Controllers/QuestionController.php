...
class QuestionController extends Controller
{
    ...
    public function question_1_submit(Request $request)
    {
        ...
        return redirect(route('question-2'));
    }
    ...
    public function getImage($number_image_cluster_1, $number_image_cluster_2, $number_image_cluster_3, $number_image_cluster_4, $number_image_cluster_5)
    {
    ...
    public function getImagePerCluster($number_image_cluster_1, $number_image_cluster_2, $number_image_cluster_3, $number_image_cluster_4, $number_image_cluster_5)
    {
        $images_1 = Image::inRandomOrder()->where('cluster_id', 1)->take($number_image_cluster_1)->get();
        $images_2 = Image::inRandomOrder()->where('cluster_id', 2)->take($number_image_cluster_2)->get();
        $images_3 = Image::inRandomOrder()->where('cluster_id', 3)->take($number_image_cluster_3)->get();
