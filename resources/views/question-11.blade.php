...
@section('content')
    <div class="container mx-auto mt-20">
        ...
        <h1 class="text-center text-5xl font-bold">Task 11</h1>
                        ...
                        <div class="grid grid-cols-5 gap-1">
                            @isset($cluster_1)
                                @foreach($cluster_1 as $image)
                                    <div class="bg-black">
                                        <input class="sr-only peer" onclick="verifyImage({{ $image->id }}, '{{ route('question-submit') }}', 12)" type="radio" value="{{ $image->id }}" name="image_id" id="{{ 'image_' . $image->id }}" required>
